wol_require("status_components")
--wol_require("gui_hacks")
Status_test  = {}
...
local function call_to_pool(u_i,sg_i)
  war_of_legends_equipment.remove(u_i, sg_i)
  war_of_legends_equipment.pool_add(sg_i)
end

local function call_from_pool(u_i,sp_i)
  local pter = war_of_legends_equipment.unit(u_i, sp_i)
  if pter == "pass" or pter == "no room" then
    war_of_legends_equipment.pool_remove(sp_i)
  end
end
...
local function call_drop(u_i,d_x,d_y,sg_i)
  war_of_legends_equipment.remove(u_i, sg_i)
  war_of_legends_equipment.item_drop(d_x, d_y, sg_i)
end

...
table.insert(list_usage, {
    ...
    "Orcish Grunt", "Orcish Warrior", "Orcish Marauder",
    "Orcish Subjugator", "Orcish Warlord", "Orcish High Warlord",
    "Orcish Archer", "Orcish Crossbowman", "Orcish Slurbow",
    "Orcish Assassin", "Orcish Slayer", "Orcish Nightblade",
    "Spearman", "Swordsman", "Pikeman",
    "Javelineer", "Royal Guard", "Halberdier",
    "Sergeant", "Lieutenant", "General", "Grand Marshal",
    "Horseman", "Lancer", "Knight", "Paladin", "Grand Knight",
    ...
    "Elvish Fighter", "Elvish Archer", "Elvish Ranger",
    "Elvish Hero", "Elvish Captain", "Elvish Champion",
    "Elvish Marshal", "Elvish Marksman",
    "Elvish Sharpshooter", "Elvish Avenger",
    "Weaver", "Prophetess", "Ascendant",
    "Envoy", "Herald",
    "Courier", "Reaver", "Dreadnought",
    "Emissary",
    "Scribe", "Savant", "Arbiter", "Librarian",
    "Runeforger",
    "Seeker", "Skyrunner", "Stormbringer",
    "Pathfinder", "Farstrider",
    "Gatekeeper", "Lorekeeper", "Oathkeeper",
    "Heretic", "Warmonger", "Harbinger",
...
table.insert(list_usage, {
    ...
    "Spearman", "Swordsman", "Pikeman",
    "Javelineer", "Royal Guard", "Halberdier",
    "General", "Sergeant","Lieutenant", "Grand Marshal",
...
table.insert(list_usage, {
    ...
    "Orcish Archer", "Orcish Crossbowman", "Orcish Slurbow",
    "Skeleton Archer", "Bone Shooter", "Banebow",
    "Courier", "Reaver", "Dreadnought", "Emissary",
    "Weaver", "Envoy", "Herald",
    "Elvish Scout", "Elvish Rider", "Elvish Outrider",
    "Elvish Archer", "Elvish Avenger", "Elvish Ranger",
    "Elvish Marksman", "Elvish Sharpshooter",
...
table.insert(list_usage, {
    ...
    "Orcish Slurbow",
    "Heretic", "Warmonger", "Harbinger", "Emissary",
    "Elvish Fighter", "Elvish Hero", "Elvish Champion",
    "Elvish Captain", "Elvish Marshal",
    "Elvish Scout", "Elvish Rider", "Elvish Outrider",
    "Elvish Hunter", "Elvish Trapper", "Elvish Prowler"},
